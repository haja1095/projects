...
//
//    
//    $stud = "select * from users where email = '$email' and password= '$password'";
//    if($conn->query($stud)){
//			$_SESSION['success'] = 'Students logged successfully';
//		}
//    $id = $result[0]['id'];
////    $name = $result[0]['name'];
...
//$stud= mysql_query("SELECT * FROM users WHERE email='".$_POST['uemail']."' and password='$dec_password'");

...
/* @var $searchModel app\models\TblFacultySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Tbl Faculties';
...
<div class="page-content">
    ...
    <div class="tbl-faculty-index">

                        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
        
        <p>
            <?= Html::a('Create Tbl Faculty', ['create'], ['class' => 'btn btn-success btn-sm']) ?>
        </p>

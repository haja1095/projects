 ...
 * @property string $emp_omail_domain
 ...
 */
class MstEmployees extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['emp_fname', 'emp_mname', 'emp_lname', 'emp_guardname', 'emp_photo', 'user_name', 'password', 'emp_religion', 'spouse_name', 'father_name', 'scan_signature', 'emp_omail_domain'], 'string', 'max' => 255],
            [['emp_nationality', 'emp_qual', 'emp_omail', 'emp_pmail', 'emp_handphone', 'emp_landphone', 'emp_guardian_name', 'emp_mother_name', 'emp_bank_branch_name', 'fy_common_subject_name', 'nominee_name', 'emp_bank_name', 'emp_handphone_1', 'caddress_1', 'caddress_2', 'caddress_3', 'paddress_1', 'paddress_2', 'paddress_3', 'emp_spouse_name', 'emp_sname'], 'string', 'max' => 150],
            [['fax', 'pan', 'emp_bank_ifsc_code', 'emp_esi_no', 'emp_pf_no', 'emp_pzipcode', 'emp_czipcode'], 'string', 'max' => 20],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'emp_omail_domain' => 'Emp Omail Domain',
            'empno' => 'Empno',
            'emp_sname' => 'Emp Sname',

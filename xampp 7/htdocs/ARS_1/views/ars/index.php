...
<div class="ars-index">
    ...
    <div class="form-group">
        ...
        <?php $form = ActiveForm::begin(['options'=>['class'=>'form-horizontal']]); ?>
                ...
                <label class="control-label col-xs-12 col-sm-1 no-padding-right" for="food"><b>Month/Year</b></label>
                ...
                &nbsp;&nbsp;&nbsp;
                <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="food"><b>Employee Name</b></label>
                ...
                <div class="col-xs-12 col-sm-3 form-inline">
                   <?php
                    ...
                    if($full_access_right==0){
                        ...
                        echo'<div class="col-sm-8" style="padding: 8px">'.$employee_list['emp_fname'].'</div>';
                        ...
                        echo Select2::widget([
                            ...
                            'value' => '',
                            'data' => $employee_list,
                            'options' => ['multiple' => false,'id'=>'employee',/*'options'=>[3236=>['Selected'=>'selected']]*/]
                        ]);
                ...
                <div  style="padding-bottom:8px; padding-top:8px" align="right" class="col-xs-12 col-sm-1">

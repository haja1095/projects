<script>jQuery.noConflict();</script>
   <?php echo $form->create('ProductClientLicense', array('action' => 'edit', 'type'=>'file'));?>
   <fieldset class="form_start_fieldset">
<table width="99%"  align="center" border="1" cellspacing="1" cellpadding="1"  class="table_add"> 
<tr class='sub_form_heading' ><td colspan="3" ><div style="clear:both; float:left"><?php __('Edit License');?></div><div style="float:right">
...
<?php 
  ...
  <tr class="add_row0">
    ...
    <td width="59%" class="right_condent"><div id="load_products"><?php echo $form->select('product_id',$products_list,null,array('id'=>'product_id','class'=>'text_select_100', 'readonly'=>true, 'div'=>false,'error'=>false, 'label' => false,'empty'=>' -Select- '));?></div></td>
  </tr>
   <tr class="add_row0">
  ...
  <!--
    ...
    <td width="59%" class="right_condent"><?php echo $form->input('last_expiry_date',array('id'=>'last_expiry_date','type'=>'text','readonly'=>true,'error'=>false,'class'=>'text_input','label'=>false));?>
	<script type="text/javascript">
		jQuery(function($){
			$('#last_expiry_date').datepicker({dateFormat:'dd-mm-yy', changeMonth: true, changeYear: true, minDate: -100000, maxDate: +0});
			});
	</script>
	</td>
	-->
  ...
  <tr class="add_row0" id="create_category">
	...
	<script type="text/javascript">
		jQuery(function($){
			$('#created_date').datepicker({dateFormat:'dd-mm-yy', changeMonth: true, changeYear: true, minDate: -100000, maxDate: +0});
			});
	</script>
	</td>
  </tr>
  ...
  <tr class="add_row0">
	...
	<script type="text/javascript">
		jQuery(function($){
			$('#expire_date').datepicker({dateFormat:'dd-mm-yy', changeMonth: true, changeYear: true});
			});
	</script>
	</td>
  </tr>
  <tr class="add_row0" id="create_category3">
   ...
   <tr class="add_row0" id="create_category1">
    ...
    <td width="59%" class="right_condent"><?php echo $form->file('product_key_file_url',array('id'=>'product_key_file_url', 'type'=>'file',  'error'=>false,'class'=>'text_input_100','label'=>false));?>
	</td>
  </tr>
  <tr class="add_row0">
  ...
  <tr class="add_row0"  id="renewal_category1">
	...
	<script type="text/javascript">
		jQuery(function($){
			$('#next_renewal_date').datepicker({dateFormat:'dd-mm-yy', changeMonth: true, changeYear: true});
			});
	</script>
	</td>
  </tr>
  ...
  <tr class="add_row0">
	...
	<?php  echo $form->submit('Save', array('div' => false, 'type'=>'submit','class'=>'save-btn' , 'url' => array('controller'=> 'ProductClientLicenses', 'action' => 'edit',$this->data['ProductClientLicense']['id']), 'loading'=>"javascript:onloading_indicator(true);",'complete'=>"javascript:onloading_indicator(false);", 'update'=> 'div_entry_form', 'loaded'=>( $ajax-> remoteFunction(array('url' => array('controller' => 'ProductClientLicenses', 'action' =>'index'), 'update' => 'indexpagging', 'frequency' => 5))) )); ?>
	</td>
  </tr>
</table>
</fieldset>

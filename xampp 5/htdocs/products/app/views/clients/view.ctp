   <?php echo $form->create('Client', array('action' => 'view'));?>
<table width="99%"  align="center" border="1" cellspacing="1" cellpadding="1"  class="table_add"> 

<tr class='sub_form_heading' ><td colspan="3" ><div style="clear:both; float:left"><?php __('View Client');?></div><div style="float:right"><input type="button" value=" &nbsp;" class="form-close-btn" onClick="javascript:hide_entry_form();"></div></td></tr>
   <tr class="add_row1">
...
<?php 
  ...
  <tr class="add_row0">
    <td width="40%" class="left_condent"><?php echo __('Client Mobile');?></td>
    <td width="1%" class="center_condent">:</td>
    <td width="59%" class="right_condent_view"><?php echo $this->data['Client']['client_mobile'];?></td>
  </tr>
  <tr class="add_row0">
    <td width="40%" class="left_condent"><?php echo __('Client Address');?></td>
    <td width="1%" class="center_condent">:</td>
    <td width="59%" class="right_condent_view"><?php echo $this->data['Client']['client_address'];?></td>
  </tr>
  <tr class="add_row0">
    <td width="40%" class="left_condent"><?php echo __('Client Products');?></td>
    <td width="1%" class="center_condent">:</td>
  ...
  <tr class="add_row1">
    ...
    <td class="right_condent_view"><?php echo  ($this->data['Client']['status']==1?'Active':'Inactive'); ?></td>
  </tr>
  <tr class="add_row0">

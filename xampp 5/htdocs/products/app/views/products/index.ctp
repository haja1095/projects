...
<div class="main_condent"  align="right">sdfsdfsdfsdfsdf
	...
	<?php
		...
		e($ajax->link('Add New ',array('controller' => 'products', 'action' =>'add_product'),array('title'=>'Add New','loading'=>"javascript:onloading_indicator(true);",'complete'=>"javascript:onloading_indicator(false);",'class'=>'add_product_link','update' => 'div_entry_form','escape' => false))); echo "|";
	?>
	...
	<?php echo $ajax->div('div_entry_form'); ?>
	 ...
	 <!-- Search Condent -->
		<?php echo $form->create('Product', array('controller'=> 'products','action'=>'add_product'));  ?>
		 <table width="100%"  border="1" cellspacing="1" cellpadding="1" class="table_filter" >
			 <tr>
				<td width="20%" height="35" class="left_condent">Product Name </td>
				<td width="2%" class="center_condent">:</td>
				<td width="23%" class="right_condent">
					<?php echo $form->select('product_name',$products_list,null,array('class'=>'text_select_100','div'=>false,'error'=>false, 'label' => false,'empty'=>'--Select--'));?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="22%"  class="center_condent" colspan="3"><?php echo $ajax->submit('Search', array('div' => false, 'class'=>'search-btn' , 'url' => array('controller'=> 'products', 'action' => 'index'), 'before'=>'clear_message();','loading'=>"javascript:onloading_indicator(true);",'complete'=>"javascript:onloading_indicator(false);",'update'=> 'indexpagging')); ?></td>
			</tr> 
		</table>
		<?php echo $form->end();?>
	<!-- Search Condent End -->
...
<?php echo $ajax->div('indexpagging',array('style'=>'clear:both;')); ?> 
 		 <!-- Pagination Condent -->		 
		<?php echo $this->element('products/index_pagging'); ?>

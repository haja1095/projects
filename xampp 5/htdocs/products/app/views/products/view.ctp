   <?php echo $form->create('MstTree', array('action' => 'view'));?>
<table width="99%"  align="center" border="1" cellspacing="1" cellpadding="1"  class="table_add"> 

<tr class='sub_form_heading' ><td colspan="3" ><div style="clear:both; float:left"><?php __('ViewProduct');?></div><div style="float:right"><input type="button" value=" &nbsp;" class="form-close-btn" onClick="javascript:hide_entry_form();"></div></td></tr>
   <tr class="add_row1">
...
<?php 
  ...
  <tr class="add_row0">
    ...
    <td width="1%" class="center_condent">:</td>
    <td width="59%" class="right_condent_view"><?php echo $this->data['Product']['product_desc'];?></td>
  </tr>
  <tr class="add_row0">
    <td width="40%" class="left_condent"><?php echo __('Product Version');?></td>
    <td width="1%" class="center_condent">:</td>
    <td width="59%" class="right_condent_view"><?php echo $this->data['Product']['product_version'];?></td>
  </tr>
  <tr class="add_row1">
    <td class="left_condent"><?php echo __('status');?></td>
    <td class="center_condent">:</td>
    <td class="right_condent_view"><?php echo  ($this->data['Product']['status']==1?'Active':'Inactive'); ?></td>
  </tr>
  <tr class="add_row0">

<script>jQuery.noConflict();</script>
  <?php echo $form->create('ProductClientLicense', array('action' => 'add_license','type' => 'file'));?>
...
<tr class='sub_form_heading' ><td colspan="3" ><div style="clear:both; float:left"><?php __('New License');?></div></td></tr>
			<tr class="add_row1">
			...
			<tr>
				...
				<td><div id="load_products"><?php echo $form->select('product_id','',null,array('id'=>'product_id','class'=>'text_select_100','div'=>false,'error'=>false, 'label' => false,'empty'=>'--Select--'));?></div></td>
			</tr>
			<!--
			<tr>
			...
			<tr id="create_category">
				...
				<script type="text/javascript">
					jQuery(function($){
						$('#created_date').datepicker({dateFormat:'yy-mm-dd', changeMonth: true, changeYear: true, minDate: -10000, maxDate: +0});
					});
		         </script>
				</td>
			</tr>
			...
			<tr id="renewal_category1">
				<td align="right"><?php echo __('Next Renewal Date :');?></td>
				<td>

<script>jQuery.noConflict();</script>
   <?php echo $form->create('ProductClientLicense', array('action' => 'edit_license', 'type'=>'file'));?>
...
<?php 
  ...
  <tr class="add_row0">
	...
	<?php  echo $form->submit('Save', array('div' => false, 'type'=>'submit','class'=>'save-btn' , 'url' => array('controller'=> 'ProductClientLicenses', 'action' => 'edit_license',$this->data['ProductClientLicense']['id']), 'loading'=>"javascript:onloading_indicator(true);",'complete'=>"javascript:onloading_indicator(false);", 'update'=> 'div_entry_form', 'loaded'=>( $ajax-> remoteFunction(array('url' => array('controller' => 'ProductClientLicenses', 'action' =>'index'), 'update' => 'indexpagging', 'frequency' => 5))) )); ?>
	</td>
  </tr>
</table>
</fieldset>
